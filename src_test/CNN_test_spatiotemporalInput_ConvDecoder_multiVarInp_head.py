...
log_directory = r'..\training\logs\%s_%s_%s_%s_%s_nextMonth_withoutwtd' %(targetvar, def_epochs, lr_rate ,batchSize, kernel)
log_dir_fig = r'..\training\logs\%s_%s_%s_%s_%s_nextMonth_withoutwtd\spatial_eval_plots' %(targetvar, def_epochs, lr_rate ,batchSize, kernel)
...
model = UNet2(input_channels=20, output_channels=1)
...
np.save(r'%s\y_pred_full_denorm.npy'%log_directory, y_pred_full_denorm)
