...
dates, lons, lats, dx, dy, sampleID, min_lon_index, max_lon_index, min_lat_index, max_lat_index = propertiesCSV("validation_samples.csv")
print(dates)

### Read spatial validation data (now a dummy to replace later, 180, 180 hardcoded)
validationData = np.random.random((len(dates), 180,180))
