...
sys.stdout.flush()
args = sys.argv
# args = ['scriptpath' , 1.0, 50, 0.0001, 4, '180', 'UNet2'] #testSize, trainSize, epochs, learning_rate, batch_size, model_type
samplesize = args[1]
...
full_tile_subsample_path = 'data/testing_random_sampling_fulltile_%s_inclwtd/subsamples'%area
