...
sys.stdout.flush()
if not os.path.exists(testing_path + '/input_training_norm_arr_limitedInpSel.npy'):
    ...
    input_training_sel = np.load(testing_path + '/input_training_norm_arr_limitedInpSel.npy')
    print('input_training_sel loaded')

if not os.path.exists(testing_path + '/input_testing_norm_arr_limitedInpSel.npy'):
    ...
    input_testing_sel = np.load(testing_path + '/input_testing_norm_arr_limitedInpSel.npy')
    print('input_testing_sel loaded')

if not os.path.exists(testing_path + '/input_validation_norm_arr_limitedInpSel.npy'):
    ...
    input_validation_sel = np.load(testing_path + '/input_validation_norm_arr_limitedInpSel.npy')
    print('input_validation_sel loaded')
...
#print how many batches are in the trainloader
len(train_loader)

'''check if best model already available'''
if os.path.exists(os.path.join(log_directory, 'best_model.pth')):
    print('best model already available')
    sys.stdout.flush()
...
sys.stdout.flush()
train.RS_val_model_newrmse(model, validation_loader,  device,  batch_size, sub_batch_size, writer=writer)
