...
log_directory = r'..\training\logs_dev2\%s_%s_%s_%s_%s_%s_LSTM_tr0.3_LSTM_CNNinp' %(targetvar, def_epochs, lr_rate ,batchSize, hidden_size, num_layers)
log_dir_fig = r'..\training\logs_dev2\%s_%s_%s_%s_%s_%s_LSTM_tr0.3_LSTM_CNNinp\figures' %(targetvar, def_epochs, lr_rate ,batchSize, hidden_size, num_layers)
...
CNN_input = xr.open_dataset(r'C:\Users\hausw001\surfdrive - Hauswirth, S.M. (Sandra)@surfdrive.surf.nl\Scripts\HybGGM\training\logs_dev2\head_10_0.0001_1_3_CNN\full_pred.nc')
